    ...
    "fr": {
        ...
        "voices": [
            {"id": "fr-FR-DeniseNeural", "name": "Denise", "gender": "Female",
             "style": "France French, natural Parisian accent, default"},
            ...
            {"id": "fr-FR-VivienneMultilingualNeural", "name": "Vivienne",
             "gender": "Female",
             "style": "Multilingual voice — can sound English-accented on isolated French words; use only when reading mixed-language text"},
        ],
    },
    "de": {
        "name": "German",
        ...
        "voices": [
            {"id": "de-DE-KatjaNeural", "name": "Katja", "gender": "Female",
             "style": "Germany German, natural Hochdeutsch accent, default"},
