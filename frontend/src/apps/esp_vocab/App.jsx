...
const config = {
  ...
  text: {
    ...
    progressJumpLabel: "Saltar a palabra",
    progressPauseLabel: "Pausar",
    progressResumeLabel: "Continuar",
    progressStopLabel: "Detener",
    queueInterrupted: "La reproducción se detuvo en la palabra",
    collapseSectionTitle: "Plegar sección",
    expandSectionTitle: "Desplegar sección",
