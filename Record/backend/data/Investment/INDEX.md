...
## weekly
- [2026-W22 周报](weekly/2026-W22.md) — 5/25-5/29；聚焦 AI 算力 vs 电力供给；Bull vs Bear 对撞 + CEG 三种估值视角 **[样本]**
...
重写后每篇 knowledge / model 末尾 link 5-9 个相关条目（之前 3-5 个）。枢纽节点：
- `lollapalooza` ← 12+ 处
- `inversion` ← 11+ 处
- `incentives` ← 11+ 处
- `circle-of-competence` ← 10+ 处
- `margin-of-safety` ← 10+ 处
- `base-rates` ← 9+ 处
- `loss-aversion` ← 9+ 处
- `power-of-compounding` ← 8+ 处
- `2008-lehman-multidimensional` ← 8+ 处
...
| 缺口 | 新增 | 互补 |
| --- | --- | --- |
| **估值方法论** | DCF + Owner Earnings | 之前 12 原则讲"判断什么"，DCF 讲"算多少" |
| **仓位数学** | Kelly Criterion | 之前没有"下多少注"的量化方法 |
| **宏观周期** | Dalio 债务周期 | 之前缺乏宏观视角 |
| **现代竞争分析** | Helmer 7 Powers | 之前 Buffett 12 原则太老，Porter 5 力太学院 |
| **战略颠覆视角** | Christensen 创新者窘境 | 之前缺乏"持仓会被怎么颠覆"的反向视角 |
| **认知大盲点** | 幸存者偏差 | 之前 loss-aversion 是"输的痛"，幸存者偏差是"听到的故事都偏" |
