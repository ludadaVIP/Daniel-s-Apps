...
const PROMPT_TEMPLATES = [
  {
    ...
    prompt:
      ...
      "5. 10 条值得记的金句\n" +
      "6. 给读者的 3 条反思问题\n" +
      "7. 朗读稿：先写「朗读大纲」和「内容结构」，再一次性写完整正文。正文必须超过 3000 个中文字符，不要先写短稿再补字；如果完成后不足 3000 字，请删掉重写。内容要原创、口语化、适合直接朗读，可以超过 3000 字，上不封顶。",
  },
  {
    id: "oneLiner",
    label: "一句话",
  ...
  },
  {
    ...
    label: "3000+ 朗读稿",
    prompt:
      "为《{{title}}》写一份中文朗读稿，必须按这个工作流输出：\n" +
      "1. 先写「朗读大纲」：列出开头、5-7 个主体段落、结尾，每段说明要解决的问题。\n" +
      "2. 再写「内容结构」：说明每个主体段落的论点、例子或类比、转场方式。\n" +
      "3. 最后写「完整朗读正文」：一次性写完，正文必须超过 3000 个中文字符。不要写一点发现不够再补一点；如果写完后数字数不足 3000，请删掉正文重新写。超过 3000 字没问题，上不封顶，优先保证质量、完整性和可朗读性。\n" +
      "要求：内容原创，不要大段摘抄原书；用口语化表达，但要有清晰论证；开头要有钩子，中间要依次展开核心思想并给例子，结尾给读者一个可以马上行动的建议。",
  },
  {
    id: "comparison",
    label: "和其他书的对比",
